  ...
  const testimonials = [
    {
      name: 'أحمد ع.',
      role: 'رائد أعمال، دبي',
      text: 'كنت أشعر بالإرهاق الدائم رغم نجاحي في العمل. بعد الجلسة، فهمت أخيراً ما كان يحدث لجسمي. الخطة بسيطة وفعالة - طاقتي تحسنت بشكل كبير خلال 3 أسابيع.',
      image: 'https://images.unsplash.com/photo-1584940120505-117038d90b05?w=400',
    },
    {
      name: 'محمد ر.',
      role: 'مدير تنفيذي، أبوظبي',
      text: 'الدكتور فهم تماماً تحديات نمط حياتي - السفر المستمر، العشاء المتأخر، الضغط العالي. الخطة تعمل مع جدولي، لا ضده. نومي تحسن 100%.',
      image: 'https://images.unsplash.com/photo-1543132220-7bc04a0e790a?w=400',
    },
    {
      name: 'خالد ب.',
      role: 'مستثمر، الرياض',
      text: 'لأول مرة أفهم نتائج تحاليلي بشكل واضح. الخطة ليست معقدة أو مستحيلة - إنها علمية وعملية. خسرت 7 كيلو وطاقتي في أعلى مستوياتها.',
      image: 'https://images.unsplash.com/photo-1587404461093-8091fba7c4f7?w=400',
    },
  ];
